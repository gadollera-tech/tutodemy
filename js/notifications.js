(() => {
  ...
  function installLiveAlertStyles() {
    ...
    style.textContent = `
      ...
      .td-live-alert-copy{min-width:0;display:grid;gap:4px}.td-live-alert-copy b{color:#11156f;font-size:.88rem;line-height:1.3}.td-live-alert-copy span{color:#666b7a;font-size:.77rem;line-height:1.42}.td-live-alert-copy a{justify-self:start;color:#11156f;font-size:.74rem;font-weight:900;text-decoration:none}.td-live-alert-copy a:hover,.td-live-alert-copy a:focus-visible{text-decoration:underline;outline:none}
      .td-live-alert-close{width:31px;height:31px;min-height:31px;padding:0;border:0;border-radius:50%;display:grid;place-items:center;background:transparent;color:#7a7e8c;font-size:1.2rem;line-height:1}.td-live-alert-close:hover,.td-live-alert-close:focus-visible{background:#f1f2f6;color:#11156f;outline:none}
